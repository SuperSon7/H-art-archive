...
class TestArtistProfileViewSet:
    ...
    def test_retrieve_own_profile(self, artist_client, artist):
        ...
        assert response.data['translations']['ko']['artist_name'] == artist.safe_translation_getter('artist_name', language_code='ko')
    ...
    def test_update_artist_profile(self, artist_client, artist):
        ...
        assert artist.safe_translation_getter('artist_name', language_code='ko') == 'Updated Artist Name' 
